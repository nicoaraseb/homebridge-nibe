...
// import {PowerConsumptionAccessory} from './nibeaccessory/PowerConsumptionAccessory';
...
//         new PowerConsumptionAccessory('6527', 'power-consumption-6527', 1, this.locale, this.serviceResolver, this.log),
